package com.brechodoslivros.app;
...
import static com.brechodoslivros.app.Globals.URL_BASE;
...
public class SignInActivity extends Activity{
	...
	protected void onPreExecute() {
		...
		nDialog.setTitle("Verificando Internet");
	...
	class SendLoginAtServer extends AsyncTask<String, Void, JSONObject>	{
		...
		private final String LOGIN_URL=URL_BASE + "login.php";
